...
import com.example.chatapp.adapters.AdapterChats;
import com.example.chatapp.pojos.Chats;
...
public class MensajesActivity extends AppCompatActivity {
    ...
    DatabaseReference ref_chat = databse.getReference("Chats");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DatabaseReference ref = databse.getReference("Estado").child(id_user_sp).child("chatcon");
